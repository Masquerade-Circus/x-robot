...
__export(visualize_exports, {
  ...
  createPngFromMachine: () => createPngFromMachine,
  createPngFromPlantUmlCode: () => createPngFromPlantUmlCode,
  createSvgFromMachine: () => createSvgFromMachine,
  createSvgFromPlantUmlCode: () => createSvgFromPlantUmlCode,
  getPlantUmlCode: () => getPlantUmlCode,
  getPlantUmlCodeFromMachine: () => getPlantUmlCodeFromMachine
});
module.exports = __toCommonJS(visualize_exports);
...
async function createImageFromPlantUmlCode(plantUmlCode, type, options = {}) {
  ...
  const outDirPath = import_path.default.resolve(process.cwd(), options.outDir || "./");
