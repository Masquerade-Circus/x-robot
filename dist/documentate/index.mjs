...
function parseStateElement(element) {
  ...
  if (datamodel) {
    ...
    if (data) {
      state.description = data.textContent || void 0;
    }
  }
  ...
  const directChildStates = elementChildNodes.filter((c) => c.nodeType === 1 && c.tagName === "state");
...
function parsePulseElements(parentElement) {
  const pulses = [];
