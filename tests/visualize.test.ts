...
describe('Readme examples', () => {
  it('Simple example', async () => {
    const toggleMachine = machine('toggle', states(state('on', transition('toggle', 'off')), state('off', transition('toggle', 'on'))), initial('off'));

    const svg = await createSvgFromMachine(toggleMachine, {
