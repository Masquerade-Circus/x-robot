[x-robot - v0.3.0](../README.md) / [Modules](../modules.md) / [x-robot/validate](../modules/x_robot_validate.md) / Err
...
[lib/validate/result.ts:29](https://github.com/Masquerade-Circus/x-robot/blob/dc79239/lib/validate/result.ts#L29)
