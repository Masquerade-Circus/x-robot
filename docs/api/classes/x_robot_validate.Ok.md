[x-robot - v1.3.0](../README.md) / [Modules](../modules.md) / [x-robot/validate](../modules/x_robot_validate.md) / Ok
...
[lib/validate/result.ts:10](https://github.com/Masquerade-Circus/x-robot/blob/c68ac33/lib/validate/result.ts#L10)
