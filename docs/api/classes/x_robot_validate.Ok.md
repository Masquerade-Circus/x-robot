[x-robot - v1.0.1](../README.md) / [Modules](../modules.md) / [x-robot/validate](../modules/x_robot_validate.md) / Ok
...
[lib/validate/result.ts:10](https://github.com/Masquerade-Circus/x-robot/blob/84ba808/lib/validate/result.ts#L10)
