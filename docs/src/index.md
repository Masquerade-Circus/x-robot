...
heroAlt: X-Robot
tagline: X-Robot is a finite state machine library for nodejs and for the web.
actions:
...
footer: Made by <a href="https://masquerade-circus.net" target="_blank">Masquerade Circus</a> with ❤️
footerHtml: true
---
