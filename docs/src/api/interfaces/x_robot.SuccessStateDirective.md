[Api](../README.md) / [x-robot](../modules/x_robot.md) / SuccessStateDirective
...
[lib/machine/interfaces.ts:133](https://github.com/Masquerade-Circus/x-robot/blob/5edbfcd/lib/machine/interfaces.ts#L133)
