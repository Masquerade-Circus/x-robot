[Api](../README.md) / [x-robot](../modules/x_robot.md) / DangerStateDirective
...
[lib/machine/interfaces.ts:125](https://github.com/Masquerade-Circus/x-robot/blob/5edbfcd/lib/machine/interfaces.ts#L125)
