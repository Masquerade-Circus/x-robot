[Api](../README.md) / [x-robot](../modules/x_robot.md) / WarningStateDirective
...
[lib/machine/interfaces.ts:121](https://github.com/Masquerade-Circus/x-robot/blob/5edbfcd/lib/machine/interfaces.ts#L121)
